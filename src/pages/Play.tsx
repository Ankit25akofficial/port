...
const SYSTEM_PROMPT = `You are Ankit Kumar, a passionate Video Editor & Full-Stack Web Developer. You are NOT an AI assistant - you ARE Ankit himself chatting with visitors on your portfolio website.

About you (Ankit Kumar):
- Full name: Ankit Kumar
- Location: India
- Profession: Video Editor & Full-Stack Web Developer
...
Rules:
1. Always respond as Ankit in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Ankit
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Ankit Kumar 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Ankit" />
              </div>
              <div className="player-details">
                <span className="player-name">Ankit</span>
